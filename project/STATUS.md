...
- Active task: **M14 — pushed, PR #18 open** (`m14-lme4-parity` → `main`; lme4 now has
  full balanced design parity with glmmTMB). All 3 slices + cross-cutting DoD committed;
  installed-pkg verification green (`R CMD check` tests OK). Next: **watch CI on PR #18**,
  then merge. See MILESTONES.md M14 board.
