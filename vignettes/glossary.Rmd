...
The `"burch"` width margin then collapses to near parity at a true ICC of 0.6, on the one grid reaching that value,
...
(indicator) means (Jorgensen 2021). It is asymptotically equivalent to the mixed
model's random effect but a genuinely different estimator, and can differ
modestly on small designs. See
