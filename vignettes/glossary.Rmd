...
grids this package has measured that vary only the subject effect it came out
the narrower of the two in nearly every cell. How much narrower is conditional, and not in the direction one might guess:
