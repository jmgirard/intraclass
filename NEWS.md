...
* The `lavaan` (SEM) engine now fits the **crossed (Design 1) multilevel** design:
  ...
  interval. Complete, balanced data with equal cluster sizes and random raters;
  ...
  differences shrink as clusters grow). Fixed raters, nested designs,
  incomplete/unbalanced data, and the bootstrap for this design remain loud,
  classed refusals.
