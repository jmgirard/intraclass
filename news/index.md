...
- [`d_study()`](https://jmgirard.github.io/intraclass/reference/d_study.md)
  ...
  single-occasion) replicate fits are supported. Projecting the occasion
  count itself, and projecting off a ragged replicate fit, remain
  unsupported.
...
- Default **glmmTMB** engine (boundary-robust REML), with a selectable
  ...
  means), which equals the mixed-model estimate on balanced data.
