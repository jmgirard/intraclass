...
_Last hygiene check: 2026-07-17 (M54 lavaan multilevel engine shipped + archived; siblings candidate now unblocked; two doc-audit candidates added; M51 rotated out under terminal-row retention)_
...
- gtheory-reference docs audit — sweep user-facing docs (`README.Rmd`, `vignettes/engines.Rmd`, `vignettes/comparison-with-other-packages.Rmd`, roxygen/engine comments) for references to the `gtheory` package (archived off CRAN 2025-03-24; dependency removed M42/ADR-052): each mention must read as a citation of its committed historical agreement, never as an installable package or live comparison target. Added conversationally 2026-07-17
