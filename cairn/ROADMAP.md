...
| M54 | Multilevel SEM (lavaan) — engine implementation | planned | — | high | milestones/M54-lavaan-multilevel-engine.md |
...
- lavaan multilevel siblings — the cluster-level-**fixed** and incomplete/unbalanced multilevel lavaan variants (incl. the multilevel lavaan bootstrap). **Blocked on M54 shipping**; the engine row itself graduated to M54 (2026-07-16). Lineage: ADR-027 → M53 GO (D-005) — cairn/legacy/ROADMAP.md
