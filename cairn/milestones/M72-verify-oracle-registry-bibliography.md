...
- 2026-07-19: T3 shelf finding — `vispoel2022a.pdf` also arrived but is **not** the cited work: it is Vispoel, Lee, Xu & Hong (2022), *Psychological Assessment* 34(12), 1093–1111, "Expanding Bifactor Models of Psychological Traits…" — overlapping authors in a different order, different title and venue, and it contains no GENOVA, no 24-scale count, and none of the agreement figures. The maintainer then supplied `vispoel2022b.pdf`, which is the NCME paper (title, author order, and the April 9 2022 venue all match). The shelf is now 33 PDFs against an inventory recording 30 with "no orphan in either direction" — reconciled under T7.
