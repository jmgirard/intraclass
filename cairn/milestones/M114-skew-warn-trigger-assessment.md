...
- 2026-08-08: review CI round 2: check-references failed on the pre-existing stale roadmap-terminal-rows record-claim expectation (the M112 hygiene pass rotated the ROADMAP row without the tsv expectation — the same slip the M111 review fixed for M110); corrected in passing, checker green locally.
