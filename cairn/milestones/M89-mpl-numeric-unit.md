...
- [x] T4: Full verify (`NOT_CRAN=true CI=true`, lintr, `air format --check`); draft `D-016` (pole-safe numeric-`unit` `ICC(A,m)` via SB inheritance, no new oracle; lineage D-015→M88) in this file's Decisions for promotion at review.
