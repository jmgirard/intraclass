...
- [ ] T6: Remove "(M20; ADR-030)" from the `n_o` message at `R/d-study.R:229` without changing its meaning. Update any test that pins the text. Run AC6's literal sweep and the condition-text ruler.
