...
- [x] T9 (review pass-2 findings F-A/F-B/F-C): stop restating run-specific figures
      outside the note and the fixture, and settle the sweep mechanically rather than
      by hand-written grep.
