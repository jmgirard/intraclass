...
## A fifth choice, coming later: subject- vs. cluster-level
...
& van der Ark, 2021). That axis is on the roadmap and will get its own
treatment; for now
[`icc()`](https://jmgirard.github.io/intraclass/reference/icc.md) covers
the single-level two-way design.
...
ten Hove, D., Jorgensen, T. D., & van der Ark, L. A. (2021). Updated
guidelines on selecting an intraclass correlation coefficient for
interrater reliability, with applications to incomplete observational
