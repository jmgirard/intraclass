...
> the subject level and the cluster level, with raters crossed with or
> nested in clusters and subjects. Each comes with boundary-aware
...
| **intraclass** | `intraclass` | Mixed-model estimation, Monte-Carlo confidence intervals, and decision guidance |
