...
#'   deliver, including degenerate data, an uncalibrated
...
#'   effect, `"burch"` is usually the **narrower** of the two -- but by a margin
#'   that depends on the design, so
...
#'   the per-level figures for the two grids that vary only the subject effect
...
#'   the package's own simulated coverage.
#'
...
#'   raters with 25 subjects, and 10 and 2 raters with 40 subjects -- all at one
...
#'   pre-registered 0.93 floor there. That floor is a nominal-minus-2-percentage-point
...
#'   so a limit must not be read as a one-sided bound at half the complementary level.
