...
#' rated by every rater, a complete, balanced two-way design where each rater
#' is tracked across the subjects they score. So it is the reference case on which `icc()`
